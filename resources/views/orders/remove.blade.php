      ...
      <div>
        <div>
          <nav class="sm:hidden" aria-label="Back">
            <a href="{{ route('orders.show', $order) }}" class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700">
            ...
            <ol class="flex items-center space-x-4">
              ...
              <li>
                <div class="flex items-center">
                  ...
                  <a href="{{ route('orders.remove', $order) }}" aria-current="page" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">{{ __('Delete') }}</a>
                </div>
              </li>
            </ol>
          </nav>
      ...
      <div class="bg-white shadow sm:rounded-lg">
        <div class="px-4 py-5 sm:p-6">
          ...
          <div class="mt-2 max-w-xl text-sm text-gray-500">
            <p>
              {{ __('When deleting an incomplete order, the user cannot continue anymore and should start over.') }}
            </p>
          </div>
          <div class="mt-5">
